...
:: Android packaging
set AND_CERT_NAME="xMVC"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\xMVC.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\CertificatesDist.p12
set IOS_DEV_CERT_FILE=cert\Certificates.p12
set IOS_DEV_CERT_PASS=nlss123
set IOS_PROVISION=cert\iOS_Team_Provisioning_Profile.mobileprovision
...
::set APP_ID=air.NLSSMobileStage
set APP_ID=com.randanderson.xMVC
